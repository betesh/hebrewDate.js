...
assetSedraOfDate(new Date(2014, 9, 5), 3, 'סֻּכּוֹת')
assetSedraOfDate(new Date(2014, 9, 11), 3, 'סֻּכּוֹת')
...
assetSedraOfDate(new Date(2015, 2, 29), 28, 'פֶּסַח')
assetSedraOfDate(new Date(2015, 3, 4), 28, 'פֶּסַח')
...
assetSedraOfDate(new Date(2015, 8, 27), 3, 'סֻּכּוֹת')
assetSedraOfDate(new Date(2015, 9, 3), 3, 'סֻּכּוֹת')
...
assetSedraOfDate(new Date(2016, 3, 17), 32, 'פֶּסַח')
assetSedraOfDate(new Date(2016, 3, 23), 32, 'פֶּסַח')
...
assetSedraOfDate(new Date(2016, 9, 16), 3, 'סֻּכּוֹת')
assetSedraOfDate(new Date(2016, 9, 22), 3, 'סֻּכּוֹת')
...
assetSedraOfDate(new Date(2017, 3, 9), 28, 'פֶּסַח')
assetSedraOfDate(new Date(2017, 3, 15), 28, 'פֶּסַח')
