...
moedTest = ->
  edgeTestMultiDayChag('Moed', new Date(2014,3,17), 4, all: ['Pesach', 'Regel'], around: ['YomTob'], '2': ['ErebShabbat'], '3': ['Shabbat'])
  edgeTestMultiDayChag('Moed', new Date(2014,9,11), 5, all: ['Sukkot', 'Regel'], around: ['YomTob'], before: ['ErebShabbat'], '1': ['Shabbat'])

pesachTest = ->
  edgeTestMultiDayChag('Pesach', new Date(2013,2,26), 8, '1': ['YomTob'], '2': ['YomTob'], '3': ['Moed'], '4': ['Moed', 'ErebShabbat'], '5': ['Moed','Shabbat'], '6': ['Moed'], '7': ['YomTob'], '8': ['YomTob'], during: ['Regel'])
  edgeTestMultiDayChag('Pesach', new Date(2015,3,4), 8, before: ['ErebShabbat'], '1': ['Shabbat', 'YomTob'], '2': ['YomTob'], '3': ['Moed'], '4': ['Moed'], '5': ['Moed'], '6': ['Moed'], '7': ['YomTob', 'ErebShabbat'], '8': ['Shabbat', 'YomTob'], during: ['Regel'])

shabuotTest = ->
  edgeTestMultiDayChag('Shabuot', new Date(2013,4,15), 2, during: ['Regel', 'YomTob'], after: ['ErebShabbat'])
  edgeTestMultiDayChag('Shabuot', new Date(2015,4,24), 2, before: ['Shabbat'], during: ['Regel', 'YomTob'])

roshHashanaTest = ->
  edgeTestMultiDayChag('RoshHashana', new Date(2011,8,29), 2, during: ['10DaysOfTeshuba', 'YomTob'], '2': ['ErebShabbat'], after: ['Shabbat', '10DaysOfTeshuba'])
...
tenDaysOfTeshubaTest = ->
  edgeTestMultiDayChag('10DaysOfTeshuba', new Date(2011,8,29), 10, '1': ['RoshHashana', 'YomTob'], '2': ['RoshHashana', 'YomTob', 'ErebShabbat'], '3': ['Shabbat'], '9': ['ErebShabbat'], '10': ['Shabbat', 'YomKippur'])
  edgeTestMultiDayChag('10DaysOfTeshuba', new Date(2015,8,14), 10, '1': ['RoshHashana', 'YomTob'], '2': ['RoshHashana', 'YomTob'], '5': ['ErebShabbat'], '6': ['Shabbat'], '10': ['YomKippur'])
...
sukkotTest = ->
  edgeTestMultiDayChag('Sukkot', new Date(2011,9,13), 9, '1': ['YomTob'], '2': ['YomTob', 'ErebShabbat'], '3': ['Moed', 'Shabbat'], '4': ['Moed'], '5': ['Moed'], '6': ['Moed'], '7': ['Moed'], '8': ['YomTob'], '9': ['YomTob', 'ErebShabbat'], after: ['Shabbat'], during: ['Regel'])
  edgeTestMultiDayChag('Sukkot', new Date(2015,8,28), 9, '1': ['YomTob'], '2': ['YomTob'], '3': ['Moed'], '4': ['Moed'], '5': ['Moed', 'ErebShabbat'], '6': ['Moed','Shabbat'], '7': ['Moed'], '8': ['YomTob'], '9': ['YomTob'], during: ['Regel'])
